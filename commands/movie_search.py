...
def get_movie_name(message):
    ...
    bot.send_message(message.chat.id, 'Введите лимит вывода за страницу от 1 до 5:')
...
def process_user_choice(message, film, name_film, limit_film, page):
    ...
    if text.lower() == 'еще':
        ...
        if film_details['poster_url']:
            ...
            bot.send_photo(message.chat.id, film_details['poster_url'], caption=details_message)
